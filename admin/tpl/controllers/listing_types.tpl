        ...
        <tr>
            ...
            <td class="field">
                ...
                $(document).ready(function(){
                    $('input[name="add_page"]').change(function(){
                        indAddListingPageHandler();
                    });

                    indAddListingPageHandler();
                });

                var indAddListingPageHandler = function(){
                    if ($('input[name="add_page"]:checked').val() == "1") {
                        $('.admin_only_row .my-ads-common').hide();
                        $('.admin_only_row .my-ads-individual').show();
                    } else {
                        $('.admin_only_row .my-ads-common').show();
                        $('.admin_only_row .my-ads-individual').hide();
                    }
                }
        ...
        <td class="field">
            ...
            <tr>
                ...
                {if $smarty.get.action == 'edit' && !$sPost.admin}
                    {assign var='replace_common' value='<a target="_blank" class="static" href="'|cat:$rlBase|cat:'index.php?controller=pages&amp;action=edit&page=my_listings">$1</a>'}
                    {assign var='replace_ind' value='<a target="_blank" class="static" href="'|cat:$rlBase|cat:'index.php?controller=pages&amp;action=edit&page=my_'|cat:$smarty.get.key|cat:'">$1</a>'}
                    {assign var='replace_type' value=`$smarty.ldelim`type`$smarty.rdelim`}
                    <td>
                        <span class="field_description">
                            <span class="my-ads-common">{$lang.my_listings_page_hint|regex_replace:'/\[(.*)\]/':$replace_common|replace:$replace_type:$lang.listings}</span>
                            <span class="my-ads-individual hide">{$lang.my_listings_page_hint|regex_replace:'/\[(.*)\]/':$replace_ind|replace:$replace_type:$sPost.name[$smarty.const.RL_LANG_CODE]}</span>
                        </span>
                    </td>
                ...
                <td class="field">
                    ...
                    <tr>
                        ...
                        {if $smarty.get.action == 'edit' && $sPost.advanced_search}
                            ...
                            <td><span class="field_description">{$lang.search_form_hint_advanced|regex_replace:'/\[(.*)\]/':$replace}</span></td>
                        {/if}
                    </tr>
                    </table>
                </td>
                ...
                <td class="field">
                    ...
                    <tr>
                        ...
                        {if $smarty.get.action == 'edit' && $sPost.myads_search}
                            ...
                            <td><span class="field_description">{$lang.search_form_hint_myads|regex_replace:'/\[(.*)\]/':$replace}</span></td>
                        {/if}
                    </tr>
                    </table>
                </td>
