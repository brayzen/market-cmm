...
<meta itemprop="name" content="{$smd_page_title}">
{if $pageInfo.meta_description}
<meta itemprop="description" content="{$pageInfo.meta_description|strip_tags|escape:'html'}">
{/if}
...
<meta itemprop="image" content="{$photo.Photo}">
{/if}
{/foreach}
{else}
{if $smd_logo}
